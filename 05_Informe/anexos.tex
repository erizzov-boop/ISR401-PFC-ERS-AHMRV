...
Rizzo Vélez Edson Nagib & Auditoría de las seis métricas sobre conteos programáticos y re-inspección del ERS corregido; redacción de la \S5, la \S8 y la \S9 del informe & {n.º} & Anexo A (auditoría) y Anexo B (registro de defectos) en formato \id{.xlsx}; \S5, \S8 y \S9 del informe\\ \hline
