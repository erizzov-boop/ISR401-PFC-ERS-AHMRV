...
S1 & Incluir la actualización del tablero CASE en el procedimiento de cierre de toda RFC, del mismo modo que ya lo está la actualización del \id{CHANGELOG.md} & El índice de sincronización entre el ERS y Jira era del 67,1\,\%: 41 elementos aprobados no se habían propagado al tablero & Alcívar A.\\ \hline
